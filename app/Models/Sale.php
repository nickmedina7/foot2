...
class Sale extends Model
{
    ...
    public static $rules = [
        ...
        'razon_social' => ['required', 'regex:/^[\pL\s]+$/u', 'min:3', 'max:50'], // Solo letras y espacios
        'concepto' => ['required', 'regex:/^[\pL\pN\s]+$/u', 'min:5', 'max:100'], // Letras, números y espacios
    ];
    ...
    {
        return $this->belongsTo(\App\Models\User::class, 'users_id'); // Cambiado a App\Models\User
    }
